...
Aprendizes: Mantêm o salário atual.

Caso existam faltas ou atrasos registrados, o sistema bloqueia o reajuste e orienta o funcionário a procurar o RH. É uma solução prática que utiliza HTML, CSS e JavaScript para facilitar a gestão de mérito da empresa.
